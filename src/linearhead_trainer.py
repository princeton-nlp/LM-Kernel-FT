...
class LinearHeadTrainer(transformers.Trainer):
    ...
    def train(self, model_path=None, dev_objective=None):
        ...
        if model.num_labels == 1:  # Regression
            ...
            reg = LogisticRegressionCV(max_iter=5000, multi_class="multinomial", random_state=0).fit(features.numpy(), targets.numpy())
        ...
        bias_torch = torch.tensor(reg.intercept_, device=decoder.bias.device, dtype=decoder.bias.dtype)
